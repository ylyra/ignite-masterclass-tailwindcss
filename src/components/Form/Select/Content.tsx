    ...
    <Select.Portal>
      ...
      >
        <ScrollArea.Root className="h-full w-full" type="auto">
          ...
          >
            <ScrollArea.Thumb
              className="relative flex-1 rounded-lg bg-zinc-300 before:absolute before:left-1/2 before:top-1/2 before:h-full before:min-h-[44px] before:w-full before:min-w-[44px] before:-translate-x-1/2 before:-translate-y-1/2 before:content-[''] " // dark:bg-zinc-500
            />
          </ScrollArea.Scrollbar>
        </ScrollArea.Root>
      </Select.Content>
